...
/// @nodoc
mixin _$LoginEntity {
  LoginValue? get value => throw _privateConstructorUsedError;
...
abstract class $LoginEntityCopyWith<$Res> {
  ...
  $LoginValueCopyWith<$Res>? get value;
}
...
class _$LoginEntityCopyWithImpl<$Res, $Val extends LoginEntity>
  ...
  $LoginValueCopyWith<$Res>? get value {
    ...
    return $LoginValueCopyWith<$Res>(_value.value!, (value) {
...
LoginValue _$LoginValueFromJson(Map<String, dynamic> json) {
...
mixin _$LoginValue {
  ...
  String? get firsrName => throw _privateConstructorUsedError;
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $LoginValueCopyWith<LoginValue> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LoginValueCopyWith<$Res> {
  factory $LoginValueCopyWith(
          LoginValue value, $Res Function(LoginValue) then) =
      _$LoginValueCopyWithImpl<$Res, LoginValue>;
  @useResult
  $Res call(
      {String? userName,
      String? firsrName,
...
/// @nodoc
class _$LoginValueCopyWithImpl<$Res, $Val extends LoginValue>
    implements $LoginValueCopyWith<$Res> {
  _$LoginValueCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      userName: freezed == userName
          ...
          : userName // ignore: cast_nullable_to_non_nullable
              as String?,
      firsrName: freezed == firsrName
          ? _value.firsrName
          : firsrName // ignore: cast_nullable_to_non_nullable
              as String?,
      id: freezed == id
          ? _value.id
...
/// @nodoc
abstract class _$$ValueImplCopyWith<$Res> implements $LoginValueCopyWith<$Res> {
...
class __$$ValueImplCopyWithImpl<$Res>
    extends _$LoginValueCopyWithImpl<$Res, _$ValueImpl>
...
class _$ValueImpl implements _Value {
  ...
  @override
  String toString() {
    return 'LoginValue(userName: $userName, firsrName: $firsrName, id: $id, fullName: $fullName, roles: $roles, token: $token)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.firsrName, firsrName) ||
                other.firsrName == firsrName) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, userName, firsrName, id,
      fullName, const DeepCollectionEquality().hash(_roles), token);
...
abstract class _Value implements LoginValue {
