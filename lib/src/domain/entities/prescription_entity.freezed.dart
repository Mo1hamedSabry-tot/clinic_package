...
PrescriptionEntity _$PrescriptionEntityFromJson(Map<String, dynamic> json) {
  return _PrescriptionEntity.fromJson(json);
}
...
/// @nodoc
@JsonSerializable()
class _$PrescriptionEntityImpl implements _PrescriptionEntity {
  ...
  factory _$PrescriptionEntityImpl.fromJson(Map<String, dynamic> json) =>
      _$$PrescriptionEntityImplFromJson(json);
  ...
  @override
  String toString() {
    return 'PrescriptionEntity(value: $value, status: $status, isSuccess: $isSuccess, successMessage: $successMessage, correlationId: $correlationId, errors: $errors, validationErrors: $validationErrors)';
  }
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$PrescriptionEntityImplToJson(
      this,
    );
  }
}

abstract class _PrescriptionEntity implements PrescriptionEntity {
  factory _PrescriptionEntity(
          {final Object? value,
          final int? status,
          final bool? isSuccess,
          final String? successMessage,
  ...
  factory _PrescriptionEntity.fromJson(Map<String, dynamic> json) =
      _$PrescriptionEntityImpl.fromJson;
